...
//	   Convert relative path to absolute, based on the directory
//	   of the config file.
#ifdef Q_OS_WIN32
...
//	copy the cached document, because other threads may
//	destroy the cached entry immediately after mutex unlock.
...
// Try to open the file
	   ...
	   qDebug ("StaticFileController: Open file %s",
...
// Return the file content and store it also in the cache
	         ...
	         entry -> filename = path;
	         mutex. lock ();
	         cache. insert (request. getPath (),
	                              entry, entry -> document. size ());
	         mutex. unlock();
	      }
	      else {
...
void StaticFileController::setContentType (const QString fileName,
